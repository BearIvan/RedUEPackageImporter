...
class REDUELEGACYRUNTIME_API UMaterialInstanceConstant_Instanced: public UMaterialInstanceConstant
{
	GENERATED_BODY()
};

UCLASS()
class REDUELEGACYRUNTIME_API UMaterialInstanceHybrid : public UMaterialInstanceDynamic
{
	GENERATED_BODY()
public:
