...
UCLASS()
class REDUELEGACYRUNTIME_API UXSeqAct_PlayScriptedSequence : public USequenceAction
{
	GENERATED_BODY()
public:
...
UCLASS()
class REDUELEGACYRUNTIME_API UXSeqAct_HideHUDElement : public USequenceAction
{
	GENERATED_BODY()
public:
	UFUNCTION(BlueprintCallable,meta=(KismetInput,LegacyIndex = 0))
...
UCLASS()
class REDUELEGACYRUNTIME_API UXSeqAct_PatternMatcherSetGlobalFlag : public USequenceAction
{
	GENERATED_BODY()
public:
	UFUNCTION(BlueprintCallable,meta=(KismetInput,LegacyIndex = 0))
...
UCLASS()
class REDUELEGACYRUNTIME_API UXSeqAct_PlayerAbilityFilter : public USequenceAction
{
	GENERATED_BODY()
public:
	UFUNCTION(BlueprintCallable,meta=(KismetInput,LegacyIndex = 0))
...
UCLASS()
class REDUELEGACYRUNTIME_API UXSeqAct_ModifyPawnMovement : public USequenceAction
{
	GENERATED_BODY()
public:
	UFUNCTION(BlueprintCallable,meta=(KismetInput,LegacyIndex = 0))
