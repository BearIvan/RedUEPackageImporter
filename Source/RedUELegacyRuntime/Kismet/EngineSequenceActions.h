...
UCLASS()
class REDUELEGACYRUNTIME_API UXSeqAct_PlayEffect: public USequenceAction
{
	GENERATED_BODY()
public:
	UFUNCTION(BlueprintCallable,meta=(KismetInput,LegacyIndex = 0))
...
UCLASS()
class REDUELEGACYRUNTIME_API UXSeqAct_PlaySound: public USequenceAction
{
	GENERATED_BODY()
public:
	UFUNCTION(BlueprintCallable,meta=(KismetInput,LegacyIndex = 0))
...
UCLASS()
class REDUELEGACYRUNTIME_API UXSeqAct_MultiLevelStreaming: public USequenceAction
{
	GENERATED_BODY()
public:
