...
class REDUEBIOSHOCK3_API UXPatternCommandBase:public UObject
{
	GENERATED_BODY()
public:
...
UCLASS(EditInlineNew,DefaultToInstanced)
class REDUEBIOSHOCK3_API UXPatternObjectSetBase:public UObject
{
	GENERATED_BODY()
public:
...
UCLASS()
class REDUEBIOSHOCK3_API UXPatternObjectSet_Player:public UXPatternObjectSetBase
{
	GENERATED_BODY()
public:
...
UCLASS()
class REDUEBIOSHOCK3_API UXPatternObjectSet_ElizabethPawn:public UXPatternObjectSetBase
{
	GENERATED_BODY()
public:
...
UCLASS()
class REDUEBIOSHOCK3_API UXPatternCommand_KismetEvent:public UXPatternCommandBase
{
	GENERATED_BODY()
public:
...
UCLASS()
class REDUEBIOSHOCK3_API UXPatternCommand_Speak:public UXPatternCommandBase
{
	GENERATED_BODY()
public:
...
UCLASS()
class REDUEBIOSHOCK3_API UXPatternCommand_PlayAudio:public UXPatternCommandBase
{
	GENERATED_BODY()
public:
...
UCLASS()
class REDUEBIOSHOCK3_API UXPatternCommand_TimeElapsed:public UXPatternCommandBase
{
	GENERATED_BODY()
public:
...
UCLASS()
class REDUEBIOSHOCK3_API UXPatternCommand_AudioTimeElapsed:public UXPatternCommand_TimeElapsed
{
	GENERATED_BODY()
public:
...
UCLASS()
class REDUEBIOSHOCK3_API UXSeqAct_InstancePattern : public USequenceAction
{
	GENERATED_BODY()
public:
