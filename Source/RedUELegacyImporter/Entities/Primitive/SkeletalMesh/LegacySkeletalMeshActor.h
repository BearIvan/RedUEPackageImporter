...
UCLASS()
class REDUELEGACYIMPORTER_API ULegacySkeletalMeshActor : public ULegacyActor
{
	GENERATED_BODY()
public:
...
UCLASS()
class REDUELEGACYIMPORTER_API ULegacyXReactiveSkeletalMeshActor : public ULegacySkeletalMeshActor
{
	GENERATED_BODY()
public:
};