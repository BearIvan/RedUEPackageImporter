...
UCLASS()
class REDUELEGACYIMPORTER_API ULegacyParticleLODLevel : public ULegacyObject
{
	GENERATED_BODY()
public:
...
UCLASS()
class REDUELEGACYIMPORTER_API ULegacyParticleSpriteEmitter : public ULegacyObject
{
	GENERATED_BODY()
public:
...
UCLASS()
class REDUELEGACYIMPORTER_API ULegacyParticleSystem : public ULegacyObject
{
	GENERATED_BODY()
public:
