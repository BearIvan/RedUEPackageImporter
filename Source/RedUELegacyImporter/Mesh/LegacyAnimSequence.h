...
UCLASS()
class REDUELEGACYIMPORTER_API ULegacyAnimSequence : public ULegacyObject
{
	GENERATED_BODY()
...
UCLASS()
class REDUELEGACYIMPORTER_API ULegacyMorphemeAnimSequence : public ULegacyAnimSequence
{
	GENERATED_BODY()
