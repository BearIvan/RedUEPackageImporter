...
UCLASS()
class REDUELEGACYIMPORTER_API ULegacyXReactiveDynamicSMActor : public ULegacyStaticMeshActor
{
    GENERATED_BODY()
public:
};
UCLASS()
class REDUELEGACYIMPORTER_API ULegacyXReactiveInterpActor : public ULegacyXReactiveDynamicSMActor
{
    GENERATED_BODY()
public:
};
UCLASS()
class REDUELEGACYIMPORTER_API ULegacyXProxyCameraHeightActor : public ULegacyStaticMeshActor
{
    GENERATED_BODY()
public:
};
