...
UCLASS()
class REDUELEGACYIMPORTER_API ULegacyXMarker : public ULegacyMarker
{
	GENERATED_BODY()
public:
...
UCLASS()
class REDUELEGACYIMPORTER_API ULegacyXMatineeCameraActor : public ULegacyCameraActor
{
	GENERATED_BODY()
public:
...
UCLASS()
class REDUELEGACYIMPORTER_API UXLevelStreamingGroup: public ULegacyObject
{
	GENERATED_BODY()
public:
	UPROPERTY(BlueprintReadWrite)
...
UCLASS()
class REDUELEGACYIMPORTER_API ULegacyXWorldInfo : public ULegacyWorldInfo
{
	GENERATED_BODY()
public:
...
UCLASS()
class REDUELEGACYIMPORTER_API ULegacyXFloatingSection: public ULegacyActor
{
	GENERATED_BODY()
public:
	virtual void	FillActor_Implementation		(AActor* InActor) override;
