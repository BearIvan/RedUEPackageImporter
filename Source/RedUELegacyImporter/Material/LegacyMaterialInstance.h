...
UCLASS()
class REDUELEGACYIMPORTER_API ULegacyMaterialInstance : public ULegacyMaterialInterface
{
	GENERATED_BODY()
public:
...
UCLASS()
class REDUELEGACYIMPORTER_API ULegacyMaterialInstanceConstant: public ULegacyMaterialInstance
{
	GENERATED_BODY()
};