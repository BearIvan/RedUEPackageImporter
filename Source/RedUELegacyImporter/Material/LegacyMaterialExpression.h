...
UCLASS()
class REDUELEGACYIMPORTER_API ULegacyMaterialExpression : public ULegacyObject
{
	GENERATED_BODY()
public:
...
UCLASS()
class REDUELEGACYIMPORTER_API ULegacyMaterialExpressionTextureBase : public ULegacyMaterialExpression
{
	GENERATED_BODY()
public:
	UPROPERTY(BlueprintReadWrite)
...
UCLASS()
class REDUELEGACYIMPORTER_API ULegacyMaterialExpressionTextureSample : public ULegacyMaterialExpressionTextureBase
{
	GENERATED_BODY()
public:
